...
for query_paper in unique_query_papers:
    print(f'Processing query paper: {query_paper}')
    # Find the classification of the query paper
    query_classification = [meta['classification'] for meta in classification_meta if meta['corpus_id'] == query_paper]
    if len(query_classification) != 0:
        ...
        for candidate_paper in related_candidates:
            classification = [meta['classification'] for meta in classification_meta if meta['corpus_id'] == candidate_paper]
